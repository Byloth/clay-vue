...
<style lang="scss">
    ...
    @layer clay.theme
    {
        :root
        {
            --clay-input-color-background: oklch(from var(--clay-color-light) calc(l + 0.0625) c h);
            --clay-input-color-border: var(--clay-color-primary);
            --clay-input-color-outline: oklch(from var(--clay-color-primary) l c calc(h + 180));
            --clay-input-color-shadow: oklch(from var(--clay-color-primary) calc(l - 0.25) c h);
            ...
            --clay-input-scaling: 1.1;
            --clay-input-translation: 0 0.333em;
        }
        ...
        @media (prefers-color-scheme: dark)
        {
            :root
            {
                --clay-input-color-background: oklch(from var(--clay-color-dark) calc(l + 0.0625) c h);
                --clay-input-color-border: #000000;
                --clay-input-color-shadow: #000000;
            }
        }
    }
    ...
    @layer clay.components
    {
        .clay-input
        {
            ...
            &:focus
            {
                ...
                scale: var(--clay-input-scaling);
                translate: var(--clay-input-translation);
